...
- #strong[La logística de septiembre:]~El acceso no depende de la renta —el bulo se repite mucho, pero el baremo de participación no atiende a criterios socioeconómicos—, sino de un requisito material: devolver en junio el lote completo y en buen estado. Basta con que falte o se estropee un ejemplar para que la familia tenga que reponerlo o quede fuera del reparto. A eso se suman los retrasos, documentados en Madrid en cursos consecutivos, con lotes llegando en octubre a las aulas, y la fianza de entre cinco y sesenta euros que los centros pueden exigir. Nada de esto es un defecto de intención: es lo que cuesta mover cientos de miles de objetos cada verano.
...
En la enseñanza superior más exigente el manual comercial es un anacronismo. Cursos como el #link("https://web.stanford.edu/class/cs224n/")[#strong[CS224N de Stanford]], o la red del MIT OpenCourseWare, se estructuran en torno a webs estáticas alojadas en servidores institucionales, con apuntes redactados por el profesorado en texto plano y compilados a PDF, y con una capacidad de revisión inmediata: si un ejercicio genera dudas recurrentes, la corrección entra esa misma tarde en el repositorio del curso.
