...
+ #strong[Y el programa los financia igual.] El artículo 7.1 y las órdenes que fijan las cuantías @orden_2476_2025 no distinguen: se financian los materiales «ya sean comercializados o de elaboración propia». El dinero que hoy compra manuales puede pagar la reprografía de los cuadernillos. Con una salvedad que se examina más adelante, porque es la objeción presupuestaria más seria de todo el documento: el artículo 7.3 establece que, transferida la cuantía de creación, no se hace otra aportación para el mismo curso hasta pasados cuatro años, y un cuadernillo fungible hay que reimprimirlo todos los septiembres.
...
+ #strong[La unidad de contribución.] Un repositorio de REA admite obras terminadas: para participar hay que producir una unidad didáctica completa, con su guía y sus rúbricas. Contribuir es, por tanto, emprender un proyecto. Un sistema de control de versiones admite algo radicalmente distinto: la corrección de una sola frase. Y eso importa, porque el obstáculo documentado no es la falta de voluntad sino la falta de tiempo: en Secundaria, sólo el 46% del profesorado español intercambia materiales didácticos con sus compañeros al menos una vez al mes, frente al 67% en Primaria @talis_2018_colaboracion. Bajar el precio de entrada de «una unidad didáctica» a «una errata» no es un detalle técnico: es la diferencia entre participar y no hacerlo.
...
Los bancos de préstamo de libros son una buena política, y hay que reconocerlo antes de señalar sus límites: han retirado de la cuesta de septiembre un gasto que asfixiaba a muchas familias, y en Madrid alcanzan ya a cerca de 520.000 alumnos @acuerdo_gobierno_accede, en torno a tres de cada cuatro de la enseñanza obligatoria @madrid_datos_cifras_2026. El problema no está en el programa, sino en aquello que el programa se ve obligado a administrar: #strong[un objeto físico, limitado, que hay que repartir, vigilar, reponer y devolver]. De ahí se derivan unas cuantas fricciones que cualquier equipo directivo reconocerá:

- #strong[La logística de septiembre:]~El acceso no depende de la renta, sino de un requisito material: devolver en junio el lote completo y en buen estado. Basta con que falte o se estropee un ejemplar para que la familia tenga que reponerlo o quede fuera del reparto. A eso se suman los retrasos, documentados en Madrid en cursos consecutivos, con lotes llegando en octubre a las aulas @eldiario_accede_retrasos, y la fianza de entre cinco y sesenta euros que los centros pueden exigir. Nada de esto es un defecto de intención: es lo que cuesta mover cientos de miles de objetos cada verano.
...
Pedagógicamente las dos opciones son legítimas; presupuestariamente no lo son por igual, y más vale saberlo antes de elegir. El Decreto 168/2018 @decreto_168_2018 define en su artículo 3.2 los materiales de elaboración propia como los diseñados «para el desarrollo curricular #emph[completo] de áreas, materias, módulos o ámbitos», y la orden de cuantías repite la exigencia al describir lo que cubre el dinero: el material «equivalente al libro de texto necesario para el desarrollo del programa #emph[completo] de una asignatura» @orden_2476_2025. Leído en sentido estricto, eso deja fuera el cuadernillo que sólo recoge las actividades: un departamento que aspire a que el Programa Accede pague su reprografía debe apuntar al temario completo, y quien se quede en el cuadernillo tendrá que financiarlo por otra vía —los fondos ordinarios de reprografía del centro— o pedir a la Comisión de Gestión que lo interprete de otro modo. No es un obstáculo insalvable, pero es lo primero que preguntará una secretaría.
...
#figure(
  align(center)[#table(
    ...
    [Derechos de explotación del material al cabo de una década], [Ninguno: el centro posee los ejemplares, no el texto], [Íntegros: reeditar, adaptar y traducir sin pedir permiso],
  )]
  , kind: table
  )

La cifra de redacción es una estimación prudente: unas doscientas horas de trabajo docente por materia y curso, a precio de hora completa, dan unos 200.000 € para las ocho materias de los cuatro cursos de la ESO. Multiplíquese por diez y seguiría siendo calderilla repartida entre los más de 280.000 alumnos de ESO de centros públicos y concertados de la región @madrid_datos_cifras_2026.
...
- #strong[Y sobre todo: al cabo de diez años, uno de los dos modelos ha comprado algo.] Éste es el argumento de fondo, y no es cuestión de céntimos por página. Conviene formularlo con precisión, porque el reglamento del propio programa dice que los ejemplares del banco son de la Comunidad de Madrid: su artículo 6.1 atribuye a la administración «la propiedad patrimonial de todos los libros de texto y del material curricular gestionados en el Programa Accede» @decreto_168_2018. Lo que la administración #emph[no] compra no son los libros: son los #strong[derechos sobre el texto]. Es dueña de trescientas mil copias de un manual que no puede reeditar, ni corregir, ni traducir, ni adaptar para un alumno con dislexia, ni ceder a otra comunidad, porque nada de eso le pertenece; y cuando la edición caduca, su propiedad es un contenedor de papel. Redactar materiales propios es, en cambio, una inversión de capital: crea un activo público del que la administración sí tiene los derechos de explotación, reutilizable sin coste marginal, que en lugar de caducar mejora cada curso con las correcciones de quienes lo usan.

El precio del lote tampoco refleja los costes que soporta el centro: recogida y revisión en junio, fianzas, expedientes por deterioro, almacenaje, exclusión de la familia que devuelve un lote incompleto y los retrasos documentados, con lotes llegando en octubre @eldiario_accede_retrasos. Y una diferencia que cualquier jefe de estudios reconocerá: el alumno que se incorpora en febrero cuesta 270 € —o se queda sin libros— en un modelo, y en el otro lo que valga imprimir los temas que le quedan por dar, unos veinte euros.
...
Y una cuarta objeción, que es de calendario y no de dinero, y que es la más incómoda de las cuatro. El Programa Accede está diseñado para financiar un bien duradero, no un consumible. Su artículo 7.3 dispone que, transferida a un centro la cuantía de renovación, «no se realizará otra aportación para el mismo curso hasta pasados cuatro años» @decreto_168_2018, y el porcentaje anual de reposición del artículo 7.2 está reservado a supuestos excepcionales —deterioro por fuerza mayor, repetidores, aumento de líneas, alumnado que no devuelve el material—, no al gasto ordinario de volver a imprimir lo mismo cada septiembre. Un banco de libros encaja en ese calendario porque se reutiliza; un cuadernillo fungible, no. La consecuencia práctica es que un centro puede pagar con Accede la #emph[creación] del material y su primera tirada, pero las tiradas de los tres cursos siguientes quedan a expensas del presupuesto ordinario de reprografía o de una interpretación favorable de la Comisión de Gestión. #strong[Ésta es la reforma normativa que esta propuesta sí necesita], y es pequeña: que la orden anual de cuantías reconozca la reprografía de materiales propios como gasto financiable todos los cursos, y no una vez cada cuatro. Mientras no exista, el modelo es viable en un centro con reprografía holgada y frágil en uno que no la tenga.

#strong[¿Y la familia?] En un centro acogido a Accede, cero euros en ambos modelos, porque el programa financia por igual los materiales comercializados y los de elaboración propia. Fuera de Accede —otras comunidades, centros no adheridos, o el curso en que un lote se rechaza por incompleto— la diferencia es la que ya se ha visto: unos 40 € repartidos a lo largo del año frente a un desembolso de unos 190 o 200 € en la primera quincena de septiembre @ocu_vuelta_cole @anele_informe. Y con una ventaja que no aparece en ninguna tabla: el cuadernillo se subraya, se anota y se conserva.
...
Eso es, literalmente, una bifurcación docente. Y hay que reconocer que Marea Verde no la ha dejado sin salida: en la propia página de Matemáticas se invita a pedir por correo el archivo en Word o LibreOffice para adaptarlo «a necesidades del tipo de alumnado, del centro, de otra comunidad autónoma», con el compromiso explícito de devolverlo modificado «para que los autores y autoras puedan revisarlo e incorporar, con el permiso adecuado, las mejoras aportadas» @mareaverde_adaptaciones. El camino de vuelta existe, está pensado y está escrito.

Lo que no existe es la maquinaria que lo haga practicable. Ese camino consiste en un correo electrónico, un fichero adjunto y una persona que compare a mano dos documentos de Word para averiguar qué ha cambiado. No hay forma de ver las diferencias, ni de aceptar tres correcciones y discutir la cuarta, ni de saber si lo enviado se incorporó alguna vez, ni de que la siguiente adaptación parta de la anterior en lugar de volver a empezar. Y no se aplica en absoluto a la traducción valenciana, que a estas alturas es una obra paralela. #strong[El mayor proyecto colaborativo de libros de texto de España tiene resuelto el permiso para fusionar versiones y no tiene la herramienta con que hacerlo.] Es exactamente el hueco que llena el control de versiones, y ése es el único que hay que llenar: no hace falta convencer a nadie de que compartir está bien —eso ya lo tienen escrito—, sino ahorrarle el trabajo manual de cumplirlo.

== La escala nacional: Sésamath y Lelivrescolaire
<escala-nacional>
Francia demuestra que el modelo escala más allá de un grupo de voluntarios. #link("https://www.sesamath.net/")[#strong[Sésamath]] @sesamath, asociación de profesores de Matemáticas activa desde 2001, publica manuales redactados por entre setenta y cinco y cien docentes en activo, gratuitos en digital y financiados con la venta de las ediciones en papel; su trabajo obtuvo una mención del Premio UNESCO Rey Hamad Bin Isa Al-Khalifa en 2007. #strong[Lelivrescolaire.fr] @lelivrescolaire, nacido en 2009, ha llegado más lejos: contaba ya en 2016 con mil quinientos profesores contribuyentes —hoy su editorial habla de cerca de cinco mil desde el principio—, y una sola de sus colecciones reunió en nueve meses a cuatrocientos docentes que aportaron treinta mil contribuciones repartidas en diez manuales y cuatro mil páginas.
...
En la enseñanza superior más exigente el manual comercial es un anacronismo, y el aparato técnico que lo sustituye es exactamente el de esta propuesta. El #link("https://web.stanford.edu/class/cs224n/")[#strong[CS224N de Stanford]] es una web estática alojada en el servidor de la universidad, con los apuntes redactados en texto plano y servidos en PDF, y con una capacidad de revisión inmediata que un manual impreso no tiene: si un ejercicio genera dudas recurrentes, la corrección entra esa misma tarde en el repositorio del curso. El #strong[MIT OpenCourseWare] acredita la otra mitad del argumento, la de la escala: publica los materiales de miles de asignaturas y su sitio entero se genera con Hugo, un compilador de sitios estáticos —el mismo principio que aquí se propone para la web del centro, aplicado al catálogo completo de una universidad—. Cumple, eso sí, una función distinta: OpenCourseWare archiva y difunde cursos ya impartidos, no los mantiene vivos día a día.
...
+ #strong[La colaboración entre centros deja de ser un problema técnico.] En una instancia común, proponer una mejora al material de otro centro cuesta un clic; con doscientas separadas, cada intercambio exige configuración, permisos y buena voluntad. La bifurcación que hoy separa las versiones de Marea Verde en Madrid, Murcia y la Comunidad Valenciana no se debe a la falta de permiso —lo conceden por escrito— sino a que reintegrar una mejora exige un correo, un adjunto y una comparación manual.
...
- #strong[Y el precedente que aquí más se admira decidió lo contrario.] The Programming Historian, presentado unas páginas atrás como el modelo más cercano a lo que se propone, publica sus lecciones bajo #strong[CC BY 4.0], sin cláusula no comercial @ph_guia_autores. Cualquiera puede imprimir sus tutoriales y venderlos, y llevan dieciocho años aceptándolo. Su razonamiento es coherente con su naturaleza: son una revista científica cuyo objetivo es la máxima circulación, y la reutilización sin fricciones —incluida la comercial— la maximiza; además, NC les cerraría la puerta de Wikipedia y de buena parte del ecosistema abierto. La decisión de este documento es la contraria porque el supuesto de partida también lo es: aquí el material lo escribe profesorado pagado con fondos públicos, para las mismas familias a las que una editorial podría después revendérselo, y ese riesgo no es hipotético sino la denuncia que Marea Verde publicó en junio de 2026. Quien piense que el argumento de la circulación pesa más que el de la reventa tiene un precedente sólido al que acogerse, y esta elección debería revisarse si el pilotaje demuestra que la cláusula NC está frenando la reutilización entre centros más de lo que frena a las editoriales.
- #strong[Y la licencia no se cumple sola.] Marea Verde, que emplea precisamente esta licencia, denunciaba en junio de 2026 que la edición y venta de sus apuntes en plataformas comerciales se hace sin su permiso @mareaverde_licencia_2026. Una licencia declara una voluntad y proporciona el fundamento jurídico para reclamar; no sustituye a la vigilancia ni al trabajo de reclamar cuando toca.

= Conclusión: qué se propone, qué está probado y qué falta
<conclusion>
Cerremos diciendo exactamente lo mismo que se ha dicho, sin añadir un gramo. La propuesta consta de dos piezas y una consecuencia. Las piezas son el #strong[texto plano] —el profesorado redacta en Markdown, y nada más que en Markdown— y el #strong[control de versiones], que convierte un montón de ficheros dispersos en un material con historia, autoría y camino de vuelta. La consecuencia es que del mismo fichero salen tres cosas sin trabajo adicional: la web del centro, el cuadernillo listo para reprografía y la versión adaptada para quien la necesite. Todo lo técnico que este documento pide ocurre en el servidor del instituto: el docente escribe y guarda.

Y el hallazgo que más ha cambiado el tono de estas páginas es que nada de eso requiere una norma nueva. El Reglamento del Programa Accede permite desde 2018 sustituir los libros comerciales por materiales propios sin pedir permiso a nadie (art. 3.1), los financia en los mismos términos (art. 7.1) y los exime del plazo de cuatro cursos que congela al manual impreso (art. 6.2) @decreto_168_2018. La administración lleva años describiendo este modelo en su propio boletín oficial. Lo que falta no es la ley ni el dinero: son las herramientas para que un claustro pueda escribir, revisar y publicar sin que la tarea le cueste el curso.

#strong[Lo que está demostrado.] Que unos materiales abiertos en formatos universales duran décadas y se mantienen al día (MC Libre). Que un colectivo de profesorado de la pública redacta libros de texto completos con revisión por pares y los sirve a cientos de miles de personas (Marea Verde). Que el modelo escala a un país entero con cientos o miles de autores (Sésamath, Lelivrescolaire). Y que trabajar con Markdown, repositorios y propuestas de cambio no es cosa de informáticos: lo llevan haciendo dieciocho años historiadores, filólogos y bibliotecarios (The Programming Historian).

#strong[Lo que no está demostrado, y hay que decirlo primero para que no lo diga otro.] No consta ningún claustro de Secundaria en el mundo que coordine su temario mediante control de versiones. Los casos vecinos son educación superior, investigación o posgrado. Ninguno de los repositorios públicos españoles publica cifras de uso, de modo que tampoco se sabe cuánto se aprovecha lo que ya existe, y ésa debería ser la primera pregunta antes de gastar un euro más, incluida esta propuesta. La participación no será masiva: será un núcleo pequeño de mantenedores y una cola larga de correcciones menudas, que es exactamente lo que hoy no tiene por dónde llegar.

#strong[Las dos condiciones que no son negociables.] La primera la enseñan por igual el proyecto que prosperó y el que se apagó: esto funciona cuando hay alguien encargado de que funcione —con nombre, cargo y horas reconocidas— y se apaga cuando la carga recae sobre la buena voluntad de voluntarios que acaban desbordados. Docente dinamizador por departamento, reducción horaria para el coordinador TIC, y a escala autonómica una sola instancia bien cuidada en lugar de doscientas a medias. La segunda es la separación entre lo que puede publicarse en abierto y lo que sólo puede vivir en un entorno autenticado: material propio y de licencia compatible en el nivel público, y material ajeno amparado por el límite de enseñanza —junto con cualquier dato del alumnado— en el nivel de aula. Improvisar ahí es la vía más rápida de dar al traste con todo lo demás.

#strong[Y una reforma pequeña que sí hace falta pedir.] El Programa Accede está diseñado para financiar un bien duradero, no un consumible que se reimprime cada septiembre. Basta con que la orden anual de cuantías reconozca la reprografía de materiales propios como gasto financiable todos los cursos, y no una vez cada cuatro. Es la única modificación normativa que este documento reclama, y no cuesta dinero nuevo: cuesta redactar un párrafo.

Las cuentas, con todo lo anterior descontado, siguen saliendo, aunque no por donde se suele suponer. La fotocopia no es más barata que el préstamo: mantener un banco cuesta unos 28 € por alumno y curso, e imprimir unos 40 €. Lo que decide la comparación es cada cuánto hay que volver a comprarlo todo —cada reforma curricular manda al contenedor cientos de libros intactos y reinicia los 270 € desde cero— y, sobre todo, qué queda al final de la década. Hoy queda un almacén de ejemplares cuya propiedad la administración tiene, pero cuyo texto no puede reeditar, corregir, traducir ni adaptar, porque no le pertenece. El material propio es lo contrario: un activo público que en lugar de caducar mejora cada curso con las correcciones de quienes lo usan.

De ahí que la petición final sea deliberadamente modesta. No un despliegue autonómico, ni un mandato, ni una plataforma nueva: un #strong[pilotaje acotado] —un departamento, una materia, un curso académico— con dos criterios explícitos de éxito fijados de antemano: cuántas propuestas de cambio ajenas al autor original llegaron a integrarse, y si al terminar el curso el material seguía vivo. Si la respuesta a ambas es mala, se habrá gastado un curso de un departamento y se sabrá algo que nadie sabe todavía. Si es buena, el segundo centro no tendrá que argumentar nada: le bastará con enseñar el repositorio.

Y mientras eso se decide, nada impide empezar por lo pequeño, que es de donde ha salido siempre todo lo demás: redactar un tema suelto en Markdown en lugar de pelearse con Word, ordenar las fuentes de una asignatura en Zotero, o escribir un mensaje de confirmación que dentro de tres cursos explique a otra persona —o a uno mismo— por qué se cambió aquel ejercicio. El texto plano y el control de versiones llevan décadas sosteniendo buena parte de la infraestructura crítica del mundo moderno. No hay ninguna razón de fondo para que no sostengan también el temario de un instituto público.
